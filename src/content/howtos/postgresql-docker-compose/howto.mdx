...
subtitle: 'Learn to set up a local PostgreSQL database with Docker Compose using volumes, environment variables, pgAdmin integration, and advanced configuration techniques.'
---
...
- [Setting Up Jaeger with Docker on Windows](/howto/jaeger-docker-windows/)
