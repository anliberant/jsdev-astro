...
subtitle: 'Learn how to package component libraries using Rollup to produce cleaner, runtime‑free bundles with ESM, CommonJS, and UMD support.'
---
...
Here is a simple project structured for demonstration:
