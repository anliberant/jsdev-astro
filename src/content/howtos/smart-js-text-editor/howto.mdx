...
subtitle: 'Learn how to create a lightweight text editor with a floating formatting toolbar using pure JavaScript. Includes bold, italic, highlight, color, copy, and undo/redo.'
---
  ...
  <div class="wrap">
    ...
    <section class="editor" id="editorBox">
      <div class="toolbar" id="selectionBar" role="toolbar" aria-label="Formatting">
        <button class="tool" id="tBold" title="Bold (Ctrl/Cmd+B)"></button>
        ...
        <button class="tool warn" id="tHighlight" title="Toggle highlight"></button>
      ...
      <div id="doc" class="surface" contenteditable="true" spellcheck="true">
        ...
        <p>Tip: this demo uses the browser’s formatting commands for simplicity. For production, consider a more reliable rich-text approach.</p>
      </div>
    </section>
  </div>
