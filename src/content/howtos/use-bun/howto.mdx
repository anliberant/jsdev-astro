...
subtitle: 'Learn to use Bun, a fast JavaScript runtime and toolkit. Install Bun, run scripts, manage packages, and bundle code efficiently for high-performance apps.'
---
