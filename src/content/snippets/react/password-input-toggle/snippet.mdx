...
subtitle: 'A shadcn/ui-powered password field with a built-in show/hide toggle, ARIA-friendly labels, and Tailwind styling. Drop-in ready for login and signup forms.'
---
