...
type: snippets
tags: ['']
desc: "A deep dive into prototype manipulation in JavaScript: build an object that’s both callable and instantiable, supports inheritance"
subtitle: "A deep dive into prototype manipulation in JavaScript: build an object that’s both callable and instantiable, supports inheritance"
---
