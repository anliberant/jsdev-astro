...
Duplicating function parameter types by hand is fragile — change the original function signature and you have to hunt down every copy. `Parameters<Type>` extracts function parameter types as a tuple so you can reuse them automatically. Below is how it works and where it's most useful.
