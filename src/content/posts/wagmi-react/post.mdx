---
title: 'Building Web3 Frontends with React and wagmi'
slug: wagmi-react
heading: 'From Web2 to Web3: Building Decentralized Frontends with wagmi'
...
subtitle: 'Learn how to build powerful Web3 frontends using React and wagmi. Connect wallets, read smart contracts, and interact with blockchain networks easily.'
---
...
- EOA (Externally Owned Account) — a user wallet (e.g. MetaMask)
...
ABI = a JSON schema that describes the contract’s functions.
...
This adds a simple “Connect Wallet” button.
...
- [Deep Dive into Ethers.js for Blockchain Developers](/ethersjs-basics/)
