...
type: post
tags: ['error-handling']
desc: Learn effective Bash error handling with exit status, set -e, traps, logging, and custom functions to make your scripts more reliable and reliable.
subtitle: 'Learn effective Bash error handling with exit status, set -e, traps, logging, and custom functions to make your scripts more reliable and reliable.'
---
...
- [Optimizing PowerShell with a Practical PSReadLine Configuration](/psreadline-setup/)
