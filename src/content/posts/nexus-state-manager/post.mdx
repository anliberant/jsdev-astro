...
subtitle: 'Deep technical overview of Nexus State, a minimal atomic state manager with async atoms, middleware, persistence, and built-in DevTools.'
---
...
Documentation: [https://nexus-state.website.yandexcloud.net](nexus-state.website.yandexcloud.net)

Source Code: [https://sourcecraft.dev/astashkin-a/nexus-state](sourcecraft.dev/astashkin-a/nexus-state)

Demo Applications: [https://codesandbox.io/p/sandbox/nryqsj](codesandbox.io/p/sandbox/nryqsj)
