...
Documentation: [nexus-state.website.yandexcloud.net](https://nexus-state.website.yandexcloud.net)

Source Code: [sourcecraft.dev/astashkin-a/nexus-state](https://sourcecraft.dev/astashkin-a/nexus-state)

Demo Applications: [codesandbox.io/p/sandbox/nryqsj](https://codesandbox.io/p/sandbox/nryqsj)
