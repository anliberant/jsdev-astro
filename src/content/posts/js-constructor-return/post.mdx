...
subtitle: 'Discover when returning a value from a JavaScript constructor actually makes sense — and how it can produce self-constructing functions and inheritance patterns'
---
