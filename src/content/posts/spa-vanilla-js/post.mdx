...
type: post
tags: ['spa']
desc: Learn to build client-side routing in single-page apps with vanilla JavaScript. A step-by-step guide to creating a reliable SPA router without frameworks or libraries.
subtitle: 'Learn to build client-side routing in single-page apps with vanilla JavaScript. A step-by-step guide to creating a reliable SPA router without frameworks or libraries.'
---
...
History mode uses the browser's history API to update the URL without a page refresh. It uses the `window.popstate` event to detect navigation changes.
...
To create a smooth navigation experience, we need to intercept link clicks:
