...
type: post
tags: ['spa']
desc: Learn to build client-side routing in single-page apps with vanilla JavaScript. A practical guide to creating a reliable SPA router without frameworks.
subtitle: Build a reliable SPA router in vanilla JavaScript without frameworks.
---
