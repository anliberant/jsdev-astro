...
subtitle: 'Step-by-step tutorial to set up Ollama, download a model, and build a private local AI chatbot using React (Vite) and an Express.js backend—with optional streaming.'
---
...
### Windows
Download and run the installer: [download ollama](https://ollama.ai/download)
