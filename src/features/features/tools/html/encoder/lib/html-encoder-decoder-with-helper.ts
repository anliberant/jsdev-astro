...
<script>
  ...
  initializeConverter(
    ...
    if (controller) {
      // removed log: console.log('HTML Encoder & Decoder ready!');
    } else {
      // removed log: console.error('Failed to initialize HTML Encoder & Decoder');
    ...
    // removed log: console.error('Converter initialization error:', error);
  });
</script>